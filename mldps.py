...
for x in range(0,len(l1)):
    l2.append(0)
df=pd.read_csv("Manual-Data\Training.csv")
...
y = df[["prognosis"]]
np.ravel(y)
tr=pd.read_csv("Manual-Data\Testing.csv")
...
w2 = Label(root, justify=LEFT, text="Group-11", fg="white", bg="black")
...
lrLb = Label(root, text="1st disease", fg="white", bg="red")
lrLb.grid(row=15, column=0, pady=10,sticky=W)

destreeLb = Label(root, text="2nd disease", fg="white", bg="red")
destreeLb.grid(row=17, column=0, pady=10, sticky=W)

ranfLb = Label(root, text="3rd disease", fg="white", bg="red")
...
#Label(root, text="Text to get").grid(row=11,column=8, sticky=W)  #label
#Entry(root, textvariable = naam).grid(row=12, column=3, sticky=E) #entry textbox

#WSignUp = Button(root, text="print text", command=places, bg="green",fg="yellow").grid(row=13, column=3, sticky=W)
